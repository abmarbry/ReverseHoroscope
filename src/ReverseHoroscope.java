...
/**
 * This program asks the user a series of questions parsed from the websites https://www.astrology.com and https://www.tarot.com and asks the user to determine
 * which horoscopes most align with their lives in a two part (potentially more) quiz. Then, the user's "connection" with each star sign is presented. The user's
 * data is stored externally, so the user can take the quiz again over a long period of time to further determine their "connection".
 * @author Allison
 *
 */
...
public class ReverseHoroscope {
	...
	public static void main(String[] args) {
		...
		try {
			...
			while(true) {
				...
				System.out.println("\n\t\t Questions from https://www.astrology.com and https://www.tarot.com");
				choice = in.nextInt();
				switch(choice) {
	...
	/*
	 * Prints the questions and results for ReverseHoroscope.
	 * 
	 * @param selectedProfile
	 * @param connector Allows main to connect to important data generated by ReverseHoroscope questions/answers
	 */
	...
	public static void run(Profile selectedProfile, SignQuestionConnector connector) throws IOException, InputMismatchException {
		...
		for(int partIterator = 1; partIterator <= NUMBER_OF_PARTS; partIterator++) {
			...
			//Get all of the relevant information from the smaller objects using connector
	...
	/*
	 * Imports the externally-stored profiles
	 * 
	 * @return ArrayList<Profile> All of the profiles stored on this computer
	 */
	...
	/*
	 * Exports the externally-stored profiles
	 * 
	 * @param profiles
	 */
	...
	/*
	 * Prints the profile selection menu
	 * 
	 * @param profiles
	 * @return Profile The selected profile
	 */
	...
	/*
	 * Prints the results of the ReverseHoroscope quiz
	 * 
	 * @param selectedProfile 
	 */
	...
	private static void printResults(Profile selectedProfile) {
		...
		for(int signIterator = 0; signIterator < StarValue.TOTAL_SIGN_NUM; signIterator++) {
			//This bulky line prints out "SIGN: YOUR_CONNECTION/TOTAL or YOUR_CONNECTION%"
	...
	/*
	 * Gives the user the option of what to do during specific types of errors
	 * 
	 * @return ArrayList<Profile A new ArrayList<Profile> object, if the user wants to create a new one 
	 */
